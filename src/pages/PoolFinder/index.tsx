import { Currency, ETHER, JSBI, TokenAmount } from '@budzswap-libs/sdk'
import React, { useCallback, useEffect, useState } from 'react'
import { Button, ChevronDownIcon, AddIcon, CardBody, Text } from '@budzswap-libs/uikit'
                ...
                hasPosition && pair ? (
                  ...
                  <LightCard padding="45px 10px">
                    <AutoColumn gap="sm" justify="center">
                      <Text style={{ textAlign: 'center' }}>You donÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢t have liquidity in this pool yet.</Text>
