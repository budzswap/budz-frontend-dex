...
import { Card, CardBody, Text } from '@budzswap-libs/uikit'
      ...
      <CardBody>
        ...
        <RowBetween>
          <RowFixed>
            ...
            <QuestionHelper text="For each trade a 0.2% fee is paid. 0.17% goes to liquidity providers and 0.03% goes to the BudzSwap treasury." />
          </RowFixed>
          <Text fontSize="14px">
